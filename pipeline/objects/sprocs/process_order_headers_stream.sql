...
def process_order_headers_stream(session: Session) -> float:
    ...
    total_sales.write.mode("append").save_as_table("raw_pos.daily_sales_boston_t")
    
    # Return a message indicating the operation was successful
    return "Daily sales for boston have been successfully written to raw_pos.daily_sales_boston_t"
$$;
