...
CREATE OR REPLACE VIEW {{env}}_tasty_bytes.harmonized.weather_boston
AS
SELECT
...
WHERE 1=1
    AND fd.country_desc = 'United States'
    AND fd.city = 'Boston'
    AND fd.yyyy_mm like '2022%'
...
WHERE 1=1
    AND dw.country_desc IN ('United States')
